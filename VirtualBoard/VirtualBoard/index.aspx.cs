...
namespace VirtualBoard
{
    public partial class index : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ifr2.Src = rh.ReadRegeditKey("ifr2").ToString();
            ...
            {
                conn.Open();
                string query = "select submit_author,submit_time,submit_problem,judge_status,judge_remoteid from main order by submit_time limit 40";
